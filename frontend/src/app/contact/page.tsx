        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-gray-900/50 border border-gray-800/50">
            ...
            <form className="space-y-5">
              ...
              <button
                type="button"
                className="w-full py-3 rounded-xl bg-linear-to-r from-indigo-500 to-violet-500 text-white font-semibold hover:from-indigo-400 hover:to-violet-400 transition-all duration-300"
              >
                Kirim Pesan
              </button>
            </form>
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800/50">
              ...
              <div className="flex gap-3">
                {[
                  { label: "Github", url: "https://github.com/mreppang" },
                  { label: "Instagram", url: "https://www.instagram.com/mreppang/" },
                  { label: "LinkdIn", url: "https://www.linkedin.com/in/m-revan-adi-suntama-45a5b1426/" },
                ].map((social, i) => (
                  <a
                    key={i}
                    href={social.url}
